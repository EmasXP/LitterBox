...
_The entire code base is written by AI_. This project is an experiment on how far one can go with [vice coding](https://en.wikipedia.org/wiki/Vibe_coding), and also for me to better learn prompt engineering.
